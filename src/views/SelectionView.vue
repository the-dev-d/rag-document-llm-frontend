    ...
    <div class="w-full h-full grid place-items-center">
        <div class="bg-white p-10 w-11/12 md:w-1/2 aspect-[2/1] shadow-md rounded-md grid place-items-center content-center gap-6">
            ...
            <div v-if="loading" class="grid place-items-center gap-2">
                <div class="grid relative place-items-center gap-6">
                    <img class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 h-4/5 aspect-square object-cover" :src="logo" alt="">
                    <span class="loader">
                        <span class="absolute top-0 left-0 "></span>
                    </span>
                </div>
                <p class="mt-3">Please wait while we create your database.</p>
